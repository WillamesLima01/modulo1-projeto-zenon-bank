...
public class Main {
    ...
    public static void main(String[] args){
        ...
        var t2 = new Transaction(743, TransactionType.PAYMENT, new BigDecimal("850002.52"),
        ...
        List<Transaction> transactions = transactionIngestor.read("zenon-fraud-detector/data/PS_20174392719_1491204439457_log.csv");
